...
//al presionar el boton se llama fase 1
...
const siemb = document.getElementById("Siembra");
siemb.addEventListener("change", (e)=>{
    e.preventDefault();
    mifuncionSM(siemb.value);
})
