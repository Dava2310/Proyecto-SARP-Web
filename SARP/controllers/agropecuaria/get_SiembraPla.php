<?php
 ...
 $sql = "SELECT ID_Siembra FROM solicitud_proveedor INNER JOIN planificaciones ON solicitud_proveedor.ID_Planificacion=planificaciones.ID_Planificacion WHERE planificaciones.Semana = '$valor'";
