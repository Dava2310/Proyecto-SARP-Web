                        ...
                        <hr>
                            ...
                            <div class="row justify-content-between" style="margin-left: 10px; margin-bottom: 20px;">
                                <div class="  col-md-6 col-sm-12 ">
                                    <h3> Tarifa para proveedores.</h3>
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <button type="submit" class="btn btn-success glyphicon glyphicon-pencil" onclick="location.href='../contraloria/TarifaP.php'">Asignar</button>
                                </div>
                            
                            </div>
                            <div class="row justify-content-between" style="margin-left: 10px; margin-bottom: 20px;">
                                <div class="  col-md-6 col-sm-12 ">
                                    <h3> Tarifa para Fleteros.</h3>
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
