        ...
        <div class="row"> 
            ...
            <div class="col-xl-10 col-lg-9 col-md-8 col-sm-12 col-12" style="background-color: #99BC78; height: 100vh; overflow-y: scroll; ">
                <div class="contenidoInterno" style="padding-top: 25px;">
                    ...
                    <hr>
                    <form action="../../controllers/contraloria/ctrl_datosF.php" method="POST">
                        <div class="row">
                        ...
                        <hr>
                        <div class="row">
                            <div id="div-ctaP&A" class="form-group  col-md-6  col-sm-12 ">
                                ...
                                <select disabled  class="form-control"  name="cuentapropia" id="ctaP&A" onchange='mifuncionP_A(this.value,document.getElementById("Fletero").value)' >
                            ...
                            <div id="div-Banco" class="form-group  col-md-6  col-sm-12  ">
                                ...
                                <input  class="form-control" list="Banco" name="Banco" id="Banco-A" placeholder="-- SELECCIONE BANCO -- " disabled>
                                    <datalist id="Banco">
                         ...
                         function activarCampos(){
                            ...
                            function mifuncion(idP){
                                ...
                                $.ajax({
                                    ...
                                    url : '../../controllers/contraloria/get_datoP.php',
