<?php
    ...
    FROM
    odp_proveedor
    INNER JOIN solicitud_proveedor ON odp_proveedor.ID_Solicitud = solicitud_proveedor.ID_Solicitud_Proveedor
    INNER JOIN tarifas ON tarifas.ID_Solicitud_Proveedor = solicitud_proveedor.ID_Solicitud_Proveedor
    INNER JOIN siembras ON solicitud_proveedor.ID_Siembra = siembras.ID_Siembra
    INNER JOIN usuario ON siembras.ID_Proveedor = usuario.ID_Usuario WHERE odp_proveedor.Estado_Pago = 0
    ");
    ...
    INNER JOIN usuario ON camiones.ID_Fleteros = usuario.ID_Usuario
		INNER JOIN odp_fletero ON odp_fletero.ID_Solicitud = solicitud_fletero.ID_Solicitud_Fletero WHERE odp_fletero.Estado_Pago= 0");
