                        ...
                        <hr>
                            ...
                            <div class="row justify-content-between" style="margin-left: 10px; margin-bottom: 20px;">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <button type="submit" class="btn btn-success glyphicon glyphicon-pencil" onclick="location.href='../contraloria/ODPgeneral.php'">Generar reporte</button>
                                </div>
                            ...
                            <div class="row justify-content-between" style="margin-left: 10px; margin-bottom: 20px;">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <button type="submit" class="btn btn-success glyphicon glyphicon-pencil" onclick="location.href='../contraloria/ODP_NP.php'">Generar reporte</button>
                                </div>
                            ...
                            <div class="row justify-content-between" style="margin-left: 10px; margin-bottom: 20px;">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <button type="submit" class="btn btn-success glyphicon glyphicon-pencil" onclick="location.href='../contraloria/ODP_P.php'">Generar reporte</button>
                                </div>
