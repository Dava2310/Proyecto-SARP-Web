                        ...
                        <form action="../../controllers/fletero/ctrl_datosPersonales.php" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-sm">
                                    ...
                                    <input value="<?=$row->Telefono?>" disabled class="form-control" type="text" name ="tlf" id="tlf" required>
                                </div>
                                <div class="form-group col-sm">
                                    <label for="correo">Correo de Usuario:</label>
                                    <input  value="<?=$row->Email?>" disabled class="form-control" type="email" name ="correo" id="correo" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" name ="ST" id="ST" disabled>                            
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
