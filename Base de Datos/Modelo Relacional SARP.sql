...
`ID_Tarifa` int(11) NULL DEFAULT '',
`ID_Contralor` int(11) NULL DEFAULT '',
`ID_Solicitud` int(11) NULL DEFAULT '',
`Estado_Pago` int NOT NULL,
PRIMARY KEY (`ID_ODP_Fletero`) ,
INDEX `Tarifa_ID` (`ID_Tarifa`),
INDEX `Planificacion_ID` (`ID_Planificacion`),
...
`ID_Terreno` int(11) NOT NULL DEFAULT '',
`ID_Proveedor` int(11) NOT NULL DEFAULT '',
...
`Fecha_Cosecha` datetime NOT NULL DEFAULT '',
`Hectareas` float NOT NULL DEFAULT '',
`Rendimiento` float NOT NULL DEFAULT '',
`Kilos_Totales` float NOT NULL DEFAULT '',
...
`ID_Siembra` int(11) NULL DEFAULT '',
`Observaciones` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
`Estado_Aprobacion` int(11) NOT NULL,
...
`tipo_Usuario` int(11) NULL DEFAULT '',
`Nombre` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '',
`Apellido` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '',
